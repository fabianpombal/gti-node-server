...
CREATE TABLE IF NOT EXISTS `gtidb`.`TipoPregunta` (
  ...
  CONSTRAINT `hashColegioTipoPregunta`
    FOREIGN KEY (`colegio`)
...
CREATE TABLE IF NOT EXISTS `gtidb`.`TipoEstructura` (
  ...
  `colegio` VARCHAR(255) NOT NULL,
  PRIMARY KEY (`id`, `colegio`),
  CONSTRAINT `hashColegioTipoEstructura`
    FOREIGN KEY (`colegio`)
    REFERENCES `gtidb`.`Colegio` (`hash`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
CREATE TABLE IF NOT EXISTS `gtidb`.`TipoEdad` (
  ...
  `colegio` VARCHAR(255) NOT NULL,
  PRIMARY KEY (`id`, `colegio`),
  CONSTRAINT `hashColegioTipoEdad`
    FOREIGN KEY (`colegio`)
    REFERENCES `gtidb`.`Colegio` (`hash`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
CREATE TABLE IF NOT EXISTS `gtidb`.`Pregunta` (
  ...
  CONSTRAINT `idGrupoPregunta`
    ...
    ON DELETE CASCADE
    ON UPDATE CASCADE, CONSTRAINT `hashColegioPregunta`
    FOREIGN KEY (`colegio`)
    REFERENCES `gtidb`.`Colegio` (`hash`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
`colegio` VARCHAR(255) NOT NULL,
`fecha_cierre` VARCHAR(120) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `gtidb`.`PreguntasTest` (
  ...
  CONSTRAINT `idTest`
    ...
    ON DELETE CASCADE
    ON UPDATE CASCADE,
    CONSTRAINT `idColegioPreguntasTest`
    FOREIGN KEY (`colegio`)
    REFERENCES `gtidb`.`Colegio` (`hash`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
